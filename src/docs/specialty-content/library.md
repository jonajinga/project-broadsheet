...
The library is a dedicated content type for long-form works: public-domain books, serialized essays, and lengthy reports. It gives each work its own index page, individual chapter pages, a floating table of contents, reading-progress persistence, and chapter-to-chapter navigation that preserves the reader's place.
