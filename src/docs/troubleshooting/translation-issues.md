...
subtitle: How to diagnose and fix the most common problems with the GTranslate.io language picker - including the language staying stuck, the dropdown not opening, and translated text not resetting.
order: 5
updated: 2026-04-18
---
...
**As a publisher,** if you need to test the default-language experience, open a private/incognito window - it starts with no cookies.

---

## The language dropdown does not open

**Check 1 - GTranslate script loaded:**
...
**Check 2 - `gtranslate.enabled` is true:**
...
**Check 3 - script loaded correctly:**
